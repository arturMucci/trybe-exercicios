...
const cortaX = (string) => {
  ...
  let resultado;
  resultado = frase.replace('x', string);
  return resultado;
}
...
const novaString = (string) => {
  ...
  console.log(string);
  let minhasSkills = `Minhas três principais habilidades são: ${skills[0]}, ${skills[1]} e ${skills[2]}`;
  return minhasSkills
};

console.log(novaString(cortaX('Artur')));
